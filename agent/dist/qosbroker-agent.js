...
function startREST() {
  restApp.get('/performance/ping/:servingArea/:reqTimestamp', function (req, res) {
    ...
    if (req.params.servingArea == servingAreaName && !isNaN(req.params.reqTimestamp)) {
      responeJSON = {
...
function callRemoteAgents() {
  servingAreaServers.forEach(function (item) {
...
},{"express":undefined,"http":undefined,"microtime":undefined,"process":undefined,"requestify":undefined}]},{},[1]);
